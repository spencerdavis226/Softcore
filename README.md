...
| Log | Newest-first audit history with low-value rows filtered from display and CSV export always available. |
...
- [ ] Verify inactive/no-run states do not nil-error after `/sc reset confirm end run`.
